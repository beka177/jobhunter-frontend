  ...
  return (
    <div className="max-w-4xl mx-auto mt-6 px-4 pb-12">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white">Центр помощи</h1>
        <p className="mt-2 text-lg text-gray-600 dark:text-gray-300">Ответы на часто задаваемые вопросы</p>
      </div>

      {loading ? (
        <div className="text-center py-10 dark:text-gray-400">Загрузка статей...</div>
      ) : (
        <div className="space-y-6">
          {articles.length === 0 ? (
            <div className="text-center text-gray-500 dark:text-gray-400">Пока нет статей.</div>
          ) : (
